...
<!--<img src="{{ '/storage/public/'.$filename }}" alt="" title="" />-->

<!--<img src="{{ '/storage/app/public/'.$filename }}"></img>-->
<!-- Gallery -->
<!-- 
...
<div class="col-12 col-sm-6 col-lg-3">
    <img class="w-100" src="{{ url('images').'/'.$filename }}" alt="">
</div>

<img src="{{ url('images').'/'.$filename }}"></img>
